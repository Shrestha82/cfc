...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <div id="sidebar-wrapper" style="background-color: #3bb543">
        <ul class="sidebar-nav" style="margin-left:0;">
            ...
            <li><a href="<?php echo e(url('user_master')); ?>" title="Users"><i class="fa fa-user"
                                                                  aria-hidden="true"></i><span
                            style="margin-left:10px;">Users</span></a></li>
            <li><a href="<?php echo e(url('enquiry')); ?>" title="Enquiries"><i class="fa fa-users"
                                                                  aria-hidden="true"></i><span
                            style="margin-left:10px;">Enquiries</span></a></li>
            <li><a href="<?php echo e(url('lead')); ?>" title="Leads"><i class="fa fa-reply-all"
                                                           aria-hidden="true"></i><span
