<?php $__env->startSection('title','List of Menu SubCategory'); ?>

<?php $__env->startSection('content'); ?>
    
    
    <a href="#" class="btn btn-sm bg-danger btnSet btn-primary add-user pull-right">
        <span class="fa fa-plus"></span>&nbsp;Create Sub Category</a>
    <h3 class="heading">List of Sub Category</h3>
    <hr/>
    ...
    <div class="row fa-border">
        <div class="container-fluid">
            <table id="dataTable" class="display compact" cellspacing="0" width="100%">
                ...
                <tbody>
                <?php if(count($MenuSubCategory)>0): ?>
                    <?php $__currentLoopData = $MenuSubCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $MenuSubCateg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="hidden"><?php echo e($MenuSubCateg->McatID); ?></td>
                            <td id="<?php echo e($MenuSubCateg->McatID); ?>">
                                <a href="#" id="<?php echo e($MenuSubCateg->McatID); ?>" class="btn btn-sm btn-default edit-unit_"
                                   title="Edit unit">
                                    <span class="fa fa-pencil"></span></a>
                                

                                <button type="button" id="<?php echo e($MenuSubCateg->McatID); ?>"
                                        class="btn btn-sm btn-danger btnDelete" title="Inactivate"><span
                                            class="fa fa-trash-o" aria-hidden="true"></span></button>
                                
                            </td>
                            <td><?php echo e($MenuSubCateg->category->CategoryName); ?></td>
                            <td><?php echo e($MenuSubCateg->CategoryName); ?></td>
                            <td><?php echo e($MenuSubCateg->Discriptions); ?></td>
                        </tr>
    ...
    <script>
        $('.btnDelete').click(function () {
            ...
            $('#myModal .modal-body').html('<h5>Are you sure want to Delete this SubCategory<h5/>');
            $('#modalBtn').html('<a class="btn btn-sm btn-danger" href="<?php echo e(url('subcategory')); ?>/' + id +
        ...
        $(".add-user").click(function () {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('subcategory/create')); ?>",
...
//            $('#modelBtn').visible(disabled);
        ...
        $(".edit-unit_").click(function () {
            ...
            var id = $(this).attr('id');
            var editurl = '<?php echo e(url('/')); ?>' + "/subcategory/" + id + "/edit";
            $.ajax({
                type: "GET",
                contentType: "application/json; charset=utf-8",
                url: editurl,
