...
<?php endif; ?>
<?php echo Form::open(['url' => 'sentence/'.$sentence->id, 'class' => 'form-horizontal', 'id'=>'place', 'method'=>'put']); ?>
...
<div class="container-fluid">
    <div class="form-group">
        ...
        <div class='col-sm-9'>
            <?php echo Form::select('start_location_id', $places, $sentence->start_location_id,['class' => 'form-control requiredDD']); ?>
    ...
    <div class="form-group">
        ...
        <div class='col-sm-9'>
            <?php echo Form::select('end_location_id', $places, $sentence->end_location_id,['class' => 'form-control requiredDD']); ?>
    ...
    <div class='form-group'>
        ...
        <div class='col-sm-9'>
            <?php echo Form::textarea('sentence', $sentence->sentence, ['class' => 'form-control input-sm required', 'placeholder'=>'Sentence','row'=>'5']); ?>
