<?php $__env->startSection('title','Sattle Bill Report'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-2">
           <div class='col-sm-12' >
              <?php echo Form::button('Search', ['class' => 'btn btn-sm btn-primary btnnew', 'style=margin-top:0px'] ); ?>
        ...
        $(".btn-primary").click(function () {
            ...
            if (start.trim() == '') {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(url('/')); ?>' + "/search_sattledbill",
