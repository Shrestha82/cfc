...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content_block form-group">
        <div class="com-block block_header">
            ...
            ?>
            <?php $__currentLoopData = $table_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-12">
                    <br>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e($category->category); ?></h3>
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                            <?php if(count($tblss)>0): ?>
                                <?php $__currentLoopData = $tblss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <span>No Table available for <?php echo e($category->category); ?></span>
                            <?php endif; ?>
